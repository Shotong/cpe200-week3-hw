...
public class Student {
    ...
    private boolean isValidYOB(int Year) {
    ...
    public void setYob(int yob) {
        this.Year = isValidYOB(yob)?yob:this.Year;
    }
    ...
    public void setYearOfBirth(int yearOfBirth) {
        this.Year = isValidYOB(yearOfBirth)?yearOfBirth:this.Year;
    }
}